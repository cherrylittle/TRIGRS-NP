  ...
  if(outp(3)) then
     do j=1,nout
        Call MPI_GATHERV(fsmin(1+irct*(j-1):irct*j),irct,MPI_FLOAT,&
             &fsmin_0(1+(j-1)*imx1),isct,idsp,MPI_FLOAT,j-1,MPI_COMM_WORLD,ierr)
     enddo
      !j=1
       !Call MPI_GATHERV(fsmin(1+irct*(j-1):irct*j),irct,MPI_FLOAT,&
  ...
  if(outp(4)) then
     do j=1,nout
        Call MPI_GATHERV(zfmin(1+irct*(j-1):irct*j),irct,MPI_FLOAT,&
             &zfmin_0(1+(j-1)*imx1),isct,idsp,MPI_FLOAT,j-1,MPI_COMM_WORLD,ierr)
     enddo
      !j=1
      !Call MPI_GATHERV(zfmin(1+irct*(j-1):irct*j),irct,MPI_FLOAT,&
  ...
  if(outp(5)) then
     do j=1,nout
        Call MPI_GATHERV(pmin(1+irct*(j-1):irct*j),irct,MPI_FLOAT,&
             &pmin_0(1+(j-1)*imx1),isct,idsp,MPI_FLOAT,j-1,MPI_COMM_WORLD,ierr)
     enddo
      !j=1
      !Call MPI_GATHERV(zfmin(1+irct*(j-1):irct*j),irct,MPI_FLOAT,&
  ...
  if(flag<0 .or. outp(1)) then
    ...
    do j=1,nout
	 ...
	 call MPI_GATHERV(p3d(1+irct*(j-1):irct*j,k),irct,MPI_DOUBLE_PRECISION,&
	         &p3d_0(1+(j-1)*imx1,k),isct,idsp,MPI_DOUBLE_PRECISION,j-1,MPI_COMM_WORLD,ierr)
	end do
	end do
	do j=1,nout
	 Call MPI_GATHERV(newdep3d(1+irct*(j-1):irct*j),irct,MPI_DOUBLE_PRECISION,&
             &newdep3d_0(1+(j-1)*imx1),isct,idsp,MPI_DOUBLE_PRECISION,j-1,MPI_COMM_WORLD,ierr)
	 Call MPI_GATHERV(dh3d(1+irct*(j-1):irct*j),irct,MPI_DOUBLE_PRECISION,&
             &dh3d_0(1+(j-1)*imx1),isct,idsp,MPI_DOUBLE_PRECISION,j-1,MPI_COMM_WORLD,ierr)
  ...
  if(flag<=-4 .or. outp(1)) then
    ...
    do j=1,nout
	 ...
	 call MPI_GATHERV(th3d(1+irct*(j-1):irct*j,k),irct,MPI_DOUBLE_PRECISION,&
	         &th3d_0(1+(j-1)*imx1,k),isct,idsp,MPI_DOUBLE_PRECISION,j-1,MPI_COMM_WORLD,ierr)
	end do
	end do
